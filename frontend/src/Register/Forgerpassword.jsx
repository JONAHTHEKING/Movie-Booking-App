...
function ForgetPassword() {
  ...
  const validationschema = Yup.object({
    ...
    phone: Yup.number("Enter a valid Mobile Number!").required(
      "Number is Required!!"
    ),
  ...
  function onSubmit(values, { resetForm }) {
    axios
      .put(
        "http://127.0.0.1:8000/api/users/resetpassword/?username=" +
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="mainform">
              <h1 className="Reset-p">Reset</h1>
              <h1 className="pas">Password</h1>
