...
class MoviesByCinemaView(APIView):
    def get(self, request):
        cinema = request.GET.get("cinema")
        page = request.GET.get("page")
        allMovies=Movie.objects.all()
        movies = Movie.objects.filter(cinema__icontains=cinema)
...
class MoviesBycityView(APIView):
    def get(self, request):
        ...
        page = request.GET.get("page")
        movies = Movie.objects.filter(city__icontains=city)
