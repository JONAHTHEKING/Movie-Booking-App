...
urlpatterns=[
    ...
    path('movies/cinema/',csrf_exempt(MoviesByCinemaView.as_view()),name='movie-by-cinema'),
      path('movies/genre/',csrf_exempt(MoviesBygenreView.as_view()),name='movie-by-genre'),
    path('movies/city/',csrf_exempt(MoviesBycityView.as_view()),name='movie-by-city'),
